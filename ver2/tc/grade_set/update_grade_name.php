...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $new_name = $new_subject . $new_test_name;

    $sql1 = "UPDATE `junior3_grade_set` SET `test_name` = '$new_name' ,`test_date` = '$test_date' ,`subject` = '$new_subject' ,`last_set_time` = '$now_time' WHERE `week_ID` = '$week_ID' AND `test_ID` = '$test_ID'";
